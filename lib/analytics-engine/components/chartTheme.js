...
export const PREDICTION_LEGEND_FONT_SIZE = 17; // benchmark_gráficos_avaliação_predição.py
export const MOBILE_LEGEND_FONT_SIZE = 14;     // benchmark_mobile.py
export const HEATMAP_COLORBAR_FONT_SIZE = 18;  // heatmaps (colorbar faz papel de legenda)
