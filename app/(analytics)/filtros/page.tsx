...
export default function FiltrosPage() {
  ...
  // 2. ESTADOS DE DADOS DE EXPERIMENTOS/API
  ...
  const fetchCharts = async () => {
    ...
    try {
      ...
      // INSPEÇÃO NO CONSOLE: Veja o que está sendo enviado
      console.log('>>> [1] Payload enviado:', JSON.stringify(payload, null, 2));
      ...
      // INSPEÇÃO NO CONSOLE: Veja o que o backend retornou
      ...
      // INSPEÇÃO NO CONSOLE: Veja o resultado normalizado
              ...
              {Object.keys(chartTitles).map((chartKey) => {
                ...
                return (
                  <div key={chartKey} className="col-12 col-md-6">
                    <div
                      className={`card h-100 border transition-all user-select-none ${
                        isSelected
